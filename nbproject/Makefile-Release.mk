...
${OBJECTDIR}/Adyacencia.o: Adyacencia.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Adyacencia.o Adyacencia.cpp
...
${TESTDIR}/tests/PbsLaberinto.o: tests/PbsLaberinto.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PbsLaberinto.o tests/PbsLaberinto.cpp
...
${OBJECTDIR}/Adyacencia_nomain.o: ${OBJECTDIR}/Adyacencia.o Adyacencia.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Adyacencia_nomain.o Adyacencia.cpp;\
	else  \
...
${OBJECTDIR}/Laberinto_nomain.o: ${OBJECTDIR}/Laberinto.o Laberinto.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Laberinto_nomain.o Laberinto.cpp;\
	else  \
